...
public class EmployeeAttendancePage {
	...
	private void initialize() {
		...
		btnProfile.setBounds(776, 81, 144, 37);
		frameEmployeeAttendancePage.getContentPane().add(btnProfile);
		...
		btnSave.setBounds(47, 664, 135, 37);
		frameEmployeeAttendancePage.getContentPane().add(btnSave);
		
		JButton btnLogout = new JButton("Logout");
		btnLogout.setFont(new Font("Arial", Font.BOLD, 12));
		btnLogout.setBackground(Color.WHITE);
		btnLogout.setBounds(552, 664, 135, 37);
		...
		btnEdit.setBounds(277, 664, 144, 37);
		frameEmployeeAttendancePage.getContentPane().add(btnEdit);
		
		JButton btnAttendance = new JButton("Attendance");
		btnAttendance.setFont(new Font("Arial", Font.BOLD, 12));
		btnAttendance.setBackground(new Color(176, 196, 222));
		...
		btnSettings.setFont(new Font("Arial", Font.BOLD, 12));
		btnSettings.setBackground(Color.WHITE);
		btnSettings.setBounds(811, 664, 135, 37);
		frameEmployeeAttendancePage.getContentPane().add(btnSettings);
		
		JButton btnDashboard = new JButton("Dashboard");
		btnDashboard.setFont(new Font("Arial", Font.BOLD, 12));
		btnDashboard.setBackground(Color.WHITE);
		btnDashboard.setBounds(776, 270, 144, 37);
