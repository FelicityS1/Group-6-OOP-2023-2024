...
public class EmployeeProfilePage {
	...
	private void initialize() {
		...
		frmEmployeeProfilePage.setExtendedState(JFrame.MAXIMIZED_BOTH);
		...
		profileButton.setBackground(new Color(176, 196, 222));
		...
		btnLeaveRequest.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EmployeeLeavePage empLeave = new EmployeeLeavePage();
				EmployeeLeavePage.main(null);
			}
		});
		...
		searchButton.setBounds(815, 644, 135, 37);
		...
		btnSettings.setBounds(554, 647, 135, 37);
		frmEmployeeProfilePage.getContentPane().add(btnSettings);
	}
}
