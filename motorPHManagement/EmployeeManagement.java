...
public class EmployeeManagement {
	...
	private void initialize() {
		...
		scrollPane.setBounds(223, 558, 1018, 235);
		frmEmployeeManagement.getContentPane().add(scrollPane);
		
		table = new JTable();
		table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		table.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(176, 196, 222), null, null, null));
		scrollPane.setViewportView(table);
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{new Integer(1), "Garcia", "Manuell III", "10/11/1983", "966-860-270", "Valero Carpark Building Valero Street 1227, Makati City", "44-4506057-3", "820126853951", "442-605-657-000", "691295330870", "Regular", "Chief Executive Officer", "N/A", "Php 90,000", "Php1,500", "Php 2,000", "Php 1,000", "Php 45,000", "Php 535.71"},
			...
			new String[] {
				"Employee No", "Last Name", "First Name", "Birthday", "Phone No", "Address", "SSS No", "Philhealth", "TIN No", "Pagibig No", "Status", "Position", "Supervisor", "Basic Salary", "Rice Subsidy", "Phone Allowance", "Clothing Allowance", "Gross", "Hourly Rate"
			}
		) {
			Class[] columnTypes = new Class[] {
				Object.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, Object.class
			};
